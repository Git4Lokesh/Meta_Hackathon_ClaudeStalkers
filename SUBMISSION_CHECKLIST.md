...
| 4 | Mini-blog on HF **OR** <2min YouTube video (one is sufficient) | **Met** (blog) | `Blog.md` at repo root — pushed into the HF Space per organizer's explicit instruction "push Blog.MD into your HF Space". Opens with a 30-second before/after teaser + embedded verbatim rollout trace. |

...
| v7-rewardfix (GeminiHugger, full run) | SFT + GRPO + reward surgery, rank 32, 9 tasks | 200 (full) | _in flight at submission_ | _pending_ | Lakshminath's full v7 run on GeminiHugger. Still training at submission time; will finish post-deadline. Full eval left for post-submission analysis. |
